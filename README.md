...
**主要技術**: Python, PyQt5, SQLite, pandas, pdfplumber  
**コード規模**: 約8,600行  
...
### 2. **技術力の向上**
- **大規模コード**: 約8,600行の保守可能な設計
- **GUI開発**: PyQt5による本格的なデスクトップアプリ
- **データ処理**: pandasを活用した分析機能
...
├── pasmo_import.py            (PASMO明細取込)
├── category_management.py     (カテゴリ管理ダイアログ)
├── backup.py                  (バックアップ作成・復元)
├── cli_import.py              (コマンドライン取込ツール)
├── budget.db                  (SQLiteデータベース ※git管理外)
